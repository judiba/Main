...
then
clear
echo " \033[46;1;37m Instalando Dropbear aguarde \033[0m"
sleep 3
...
sleep 3
clear
echo " \033[46;1;37m Dropbear configurado com sucesso nas portas 109 e 110 porém trabalhando na porta 443 via SSLH !!!\033[0m"
fi
exit
